...
require(['jquery','bootstrap','datatables.net','bsdataTables','adminlte','user_manager','common','fnReloadAjax'],
	function(jquery,bootstrap,datatables_net,bsdataTables,adminlte,user_manager,common,fnReloadAjax){

	$(function(){
		user_manager.showUsers();
		user_manager.userSearch();
	});
});
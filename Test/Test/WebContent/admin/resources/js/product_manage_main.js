...
require(['jquery','bootstrap','datatables.net','bsdataTables','adminlte','product_manage','common','fnReloadAjax'],
	function(jquery,bootstrap,datatables_net,bsdataTables,adminlte,product_manage,common,fnReloadAjax){

	$(function(){
		product_manage.showProducts();
		product_manage.productSearch()
	});
});
...
require(['jquery','bootstrap','datatables.net','bsdataTables','adminlte','orderitems_manage','common','fnReloadAjax'],
	function(jquery,bootstrap,datatables_net,bsdataTables,adminlte,orderitems_manage,common,fnReloadAjax){

	$(function(){
		orderitems_manage.showOrderItems();
	});
});
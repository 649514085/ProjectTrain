var baseUrl="http://localhost:8080/mall/";//修改端口或项目名
...
define(function() {
    ...
    function getUserInfo(){
        ...
        */
    	...
    	$.ajax({
            ...
            type:"get",//通过Get请求，并不需要传输数据，所以Ajax中不需要写data
            ...
            success:function(user){
                ...
                if (user.status==0) {
                    ...
                    //将用户名添加到对应位置
                    $("#LoginName").html(user.data.user_id);
                    //获取用户购物车商品数量
                    getCartCount();
                }
            }
    ...
    function getCartCount() {
        ...
        $.ajax({
            url:baseUrl+"cart/getcartscount.do",

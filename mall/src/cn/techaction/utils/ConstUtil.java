...
public class ConstUtil {
	...
	public static class ProductStatus{
		...
		public static final int STATUS_ON_SALE=1;	   //上架，在售
	...
	public static class OrderStatus{
		...
		public static final int ORDER_NO_PAY=0;		//未付款
		public static final int ORDER_PAID=1;		//已经付款
		public static final int ORDER_SHIPPED=2;	//已经发货
		public static final int ORDER_SUCCESS=3;	//订单完成
		//public static final int ORDER_CLOESD = 5;	//订单关闭
		public static final int ORDER_CANCELED=4;  //订单取消
		public static String getStatusDesc(int code) {
			String desc="未知状态";
			switch (code) {
			case ORDER_CANCELED:
	...
	public static class HotStatus{
		...
		public static final int NORMAL_STATUS=0;	//非热销
	...
	public static class ProductType{
		public static final int TYPE_HNTJX=1;	//混凝土机械
		public static final int TYPE_JZQZJJX=4;	//建筑起重机机械
		public static final int TYPE_GCQZJJX=2;	//工程起重机机械
		public static final int TYPE_LMJX=7;	//路面机械
	}
